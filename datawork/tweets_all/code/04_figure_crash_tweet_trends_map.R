...
## Load Roads 
roads <- readRDS(file.path(data_roadgaz_dir, "raw_data", "gis_osm_roads_free_1_nairobi.Rds"))
...
## Crash Centroid Dataframe
# tweets_clustered_OVER_nairobi <- over(tweets_clustered, nairobi)
# tweets_clustered <- tweets_clustered[!is.na(tweets_clustered_OVER_nairobi$NAME_1),]
